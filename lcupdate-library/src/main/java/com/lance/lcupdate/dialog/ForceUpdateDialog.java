package com.lance.lcupdate.dialog;
...
import com.lance.lcupdate.R;
import com.lance.lcupdate.callback.DownloadCallback;
import com.lance.lcupdate.http.downloadRequest;
import com.lance.lcupdate.utils.ApplicationUtil;
import com.lance.lcupdate.utils.NetWorkUtil;
...
public class ForceUpdateDialog extends Dialog {
    ...
    private void initData() {
        ...
        forceUpdateSize.setText("大小:" + mAppSize );
    ...
    public void download() {
        ...
        downloadRequest.download(mDownloadUrl, mFilePath, mFileName, new DownloadCallback() {
            @Override
     ...
     * 设置软件大小
     */
    public ForceUpdateDialog setAppSize(String appSize) {
